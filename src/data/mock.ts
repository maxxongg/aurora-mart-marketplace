import { Product, Category, Banner, Order, User, Settings } from "@/types";
...
export const mockProducts: Product[] = [
  {
    id: "1", name: "Wireless Bluetooth Headphones", description: "Premium wireless headphones with active noise cancellation, 30-hour battery life, and ultra-comfortable over-ear design. Perfect for music lovers and professionals alike.",
  ...
  {
    id: "2", name: "Smart Watch Pro X", description: "Advanced smartwatch with health monitoring, GPS tracking, and a stunning AMOLED display. Stay connected and track your fitness goals with precision.",
  ...
  {
    id: "3", name: "Minimalist Leather Backpack", description: "Handcrafted genuine leather backpack with laptop compartment. Elegant design meets everyday functionality.",
  ...
  {
    id: "4", name: "Organic Cotton T-Shirt", description: "Sustainably sourced 100% organic cotton t-shirt. Soft, breathable, and available in multiple colors.",
  ...
  {
    id: "5", name: "Ceramic Plant Pot Set", description: "Set of 3 modern ceramic plant pots with drainage holes. Perfect for indoor herb gardens and succulents.",
  ...
  {
    id: "6", name: "Professional Yoga Mat", description: "Extra thick, non-slip yoga mat with alignment lines. Eco-friendly TPE material for comfortable practice.",
  ...
  {
    id: "7", name: "Luxury Skincare Set", description: "Complete skincare routine with cleanser, toner, serum, and moisturizer. Formulated with natural ingredients.",
  ...
  {
    id: "8", name: "Bestselling Novel Collection", description: "Curated collection of 5 award-winning novels. A perfect gift for avid readers.",
  ...
  {
    id: "9", name: "Portable Bluetooth Speaker", description: "Waterproof portable speaker with 360° sound, 20-hour battery, and built-in microphone for calls.",
  ...
  {
    id: "10", name: "Running Shoes Elite", description: "Lightweight performance running shoes with responsive cushioning and breathable mesh upper.",
  ...
  {
    id: "11", name: "Stainless Steel Water Bottle", description: "Double-wall vacuum insulated bottle keeps drinks cold for 24h or hot for 12h. BPA-free.",
  ...
  {
    id: "12", name: "Wireless Charging Pad", description: "Fast wireless charging pad compatible with all Qi-enabled devices. Sleek, minimal design.",
...
export const mockOrders: Order[] = [
  {
    ...
    items: [
      { id: "1", productId: "1", quantity: 1, price: 79.99 },
      { id: "2", productId: "2", quantity: 1, price: 199.99 },
    ],
  },
  {
    ...
    items: [
      { id: "3", productId: "3", quantity: 1, price: 89.99 },
    ],
  },
  {
    ...
    items: [
      { id: "4", productId: "6", quantity: 1, price: 45.99 },
      { id: "5", productId: "7", quantity: 1, price: 64.99 },
      { id: "6", productId: "4", quantity: 1, price: 29.99 },
    ],
  },
];
