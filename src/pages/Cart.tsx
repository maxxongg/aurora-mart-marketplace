        ...
        <div className="lg:col-span-2 space-y-4">
          {items.map((item) => (
            <div key={item.id} className="flex gap-4 p-4 rounded-lg border bg-card">
              <Link to={`/product/${item.product.id}`} className="h-24 w-24 rounded-lg overflow-hidden shrink-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground mt-0.5">${item.product.price.toFixed(2)} each</p>
