  ...
  if (!isAuthenticated) {
    return (
      <div className="container mx-auto py-20 text-center">
        ...
        <p className="text-muted-foreground mb-6">Save your favorite items by signing in to your account.</p>
        <Button asChild className="gradient-primary border-0 text-primary-foreground"><Link to="/auth">Sign In</Link></Button>
      </div>
    );
  }
